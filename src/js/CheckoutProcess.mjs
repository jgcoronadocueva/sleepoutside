...
export default class CheckoutProcess {
  ...
  calculateItemSummary() {
    ...
    let displayAmount = document.querySelector(
      this.outputSelector + " #num-items",
    );
    displayAmount.innerHTML = this.itemTotal;

    let displaySubTotal = document.querySelector(
  ...
  displayOrderTotals() {
    ...
    let displayShipping = document.querySelector(
    ...
    let displayTotal = document.querySelector(
